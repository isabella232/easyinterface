...
CodeMirror.defineMode("clike", function(config, parserConfig) {
  ...
  def("text/abs", {
    name: "clike",
    keywords: words("module import export from"  +                     //the top levels
		    ...
		    " duration" +                                      //  guard / statement
                    ""),
    types: words(cTypes),
    blockKeywords: words("case class else for foreach then switch try while"),
    defKeywords: words("function local class"),
    typeFirstDefinitions: true,
    atoms: words("True False null this Nil Cons"),
    hooks: {"#": cppHook},
    modeProps: {fold: ["brace", "include"]}
  });
